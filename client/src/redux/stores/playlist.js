import { ADD_MUSIC, DELETE_MUSIC, CHANGE_NOWPLAYING } from '../actions/playlist'
...
const initialState =  {
  ...
  playlist : [{
    ...
    audio: "https://p.scdn.co/mp3-preview/95a1c576b938bd5c9a091654328fe2c66d6abd77?cid=9ebd371789ec4d41a6e4091dffeec2cb",
    elements : [{
      id : '1',
      category : 'love',
      coordinate : [0,0]
